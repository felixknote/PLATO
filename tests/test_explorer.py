...
def test_combined_with_merges_without_losing_the_first_folders_matches(tmp_path):
    ...
    (Aug26 CRISPRi & ABx splits CRISPRi and ABx into separate subfolders);
    ...
    # Neither folder alone resolves everything -- that is the point.
    assert first.report.fraction < 1.0
    assert second.report.fraction < 1.0
